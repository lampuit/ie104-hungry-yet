...
export function SearchingArea({
  ...
  }, [search, rating, filter, onFilterChange, debouncedFilterAndSearch]);
  ...
  return (
    <div className="flex flex-col items-center justify-between space-y-4 px-4 py-6 sm:flex-row sm:space-x-4 sm:space-y-0">
      ...
      <div className="flex w-full items-center justify-end space-x-2 sm:w-auto sm:space-x-4">
        <div
        ...
        >
          <input
            ...
            className="w-full rounded-full border border-gray-300 px-4 py-2 text-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 sm:w-64"
