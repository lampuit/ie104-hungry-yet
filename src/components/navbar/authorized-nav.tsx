  ...
  return (
    <nav className="flex flex-row px-10 py-5 justify-between items-center h-20 w-full max-w-screen-2xl text-white">
      <Link href={"/"} className="grow flex flex-row justify-start min-w-52 items-center">
        ...
        {isCartPage ?
          <span className="sm:text-xl md:text-2xl font-bold"><span className="pr-2">|</span>Giỏ Hàng</span>
          : isCheckoutPage ?
            <span className="sm:text-xl md:text-2xl font-bold"><span className="pr-2">|</span>Thanh Toán</span>
            : null
        }
      </Link>
