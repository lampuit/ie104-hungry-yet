...
export function MobileBenefit() {
    return (
        <div className="flex flex-col sm:hidden justify-center items-center w-screen align-center gap-8 py-6">
            <div className="flex flex-col justify-around items-center text-center h-56 w-64 bg-neutral-100 p-4">
