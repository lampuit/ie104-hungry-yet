...
export function Benefit() {
    return (
        <div className="hidden sm:flex justify-center w-screen align-center gap-8 bg-neutral-100 py-6">
            <div className="flex flex-col justify-around items-center text-center h-56 lg:w-64 md:w-48 w-28">
