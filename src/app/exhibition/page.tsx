        ...
        <div className='flex flex-col items-center gap-4'>
            ...
            <div className='flex flex-wrap justify-center items-center gap-3 w-4/5'>
                {products?.map((product, index) => {
                    return (
                        <div key={index} className='relative w-[300px] h-[200px] overflow-clip bg-black'>
                            <Image src={product.imageUrl}
                                alt={product.name}
                                layout="fill"
                                objectFit='cover'
                                className='absolute transition transform duration-300 ease-in-out hover:scale-125 hover:opacity-50 z-0'
                            >
                            </Image>
